...
<!--WILDAN RIZQULLAH BIN KHAIRUL NIZAM 52052120061-->
<!--SAYED AMIRUL HAZIQ BIN SAYED MOHAMAD KAMIL 52052120077-->
<!--Azure Foundation-->
<!--NORSHAHARIZAN PUTEH-->
<!--WEEK 17-->
*/
...
var questions = [
  ...
  */
  var onComplete = function () {
    ...
    h1.appendChild(document.createTextNode('Together  ' + questions[0].answer + ' ,we create a life-changing wishes for the need. Even the the smallest contribution can make an impact on someone in need. Thank you for be part of us.'))
    setTimeout(function () {
      register.parentElement.appendChild(h1)
      setTimeout(function () { h1.style.opacity = 1 }, 50)
      setTimeout(function() {h1.style.width = "50%"})
    }, 1000)
